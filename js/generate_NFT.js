...
window.addEventListener('DOMContentLoaded', function() {
    document.getElementById('button').addEventListener('click', async function(e){
        ...
        let extName = sessionStorage.getItem(1).split(',')[0];
        ...
        //     process.exit(1);
        // }else{
        //     buffer = Buffer.from(sessionStorage.getItem(1), 'base64');
        // }
        buffer = Buffer.from(sessionStorage.getItem(1).split(',')[1], 'base64');
